            ...
            <div class="mb-3">
                <label for="industry_type" class="form-label">Industry</label>
                    <select name="industryType"  id="industryType" class="form-select" required>
                        ...
                        <option value="transportation_communications_electric_gas_and_sanitary_services">Transportation, Communications, Electric, Gas, and Sanitary Services</option>
                        <option value="wholesale_trade">Wholesale Trade</option>
                        <option value="retail_trade">Retail Trade</option> --&gt;
                        <option value="finance_insurance_and_real_estate">Finance, Insurance, and Real Estate</option>
