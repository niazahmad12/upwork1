            ...
            <div class="mb-3">
                ...
                <input  type="text" name="businessPhoneNumber" id="businessPhoneNumber"  class="form-control" placeholder="########## "   required maxlength="10">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <input type="text" name="businessRepresentativeAddress1" id="businessRepresentativeAddress1" class="form-control"   placeholder="Address line 1" required>
            </div>
            <div class="mb-3">
                <input type="text" name="businessRepresentativeAddress2" id="businessRepresentativeAddress2" class="form-control"  placeholder="Address line 2">
            </div>
            <div class="mb-3">
                <input type="text" name="businessRepresentativeCity" id="businessRepresentativeCity" class="form-control"  placeholder="City" required>
            </div>
            <div class="mb-3">
                <label for="states" class="form-label">State</label>
                <select class="form-select" name="businessRepresentativeState" id="businessRepresentativeState">
                    <?=states_list()?>
                </select> 
                <input type="text" name="businessRepresentativeState2" id="businessRepresentativeState2" class="form-control" placeholder="state" style="display: none;"> 
            </div>
            <div class="mb-3">
                <input type="text" name="businessRepresentativeStateZipCode" id="businessRepresentativeZipCode" class="form-control"  placeholder="Zip"  style="width: 300px !important;">
            </div>